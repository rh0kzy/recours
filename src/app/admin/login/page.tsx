  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 max-w-md w-full space-y-8">
        ...
        {/* Login Form */}
        <div className="mt-8 bg-gray-800/50 backdrop-blur-sm py-8 px-6 shadow-2xl rounded-2xl border border-gray-700">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input
                ...
                className="appearance-none relative block w-full px-4 py-3 border border-gray-600 bg-gray-700/50 text-white placeholder-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
